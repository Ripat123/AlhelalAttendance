package com.sbitbd.alhelalacademy.activity;
...
//    };
    ...
    private void initUI() {
        ...
        portrait.setImageResource(R.drawable.ic_user);
        peer_id = findViewById(R.id.peer_id);
...
//        }
        ...
        call_status = intent.getIntExtra(Constants.KEY_CALLING_STATUS,0);
        if (mPeer != null) {
            try {
//                int peer = Integer.parseInt(mPeer);
//                for (int i = mPeerUidText.length - 1; i >= 0; i--) {
//                    int digit = peer % 10;
//                    peer /= 10;
//                    mPeerUidText[i].setText(String.valueOf(digit));
//                }
                peer_id.setText(mPeer);
    ...
    private void sendInvitation() {
        inviteCall(mPeer, mChannel,call_status);
    }
