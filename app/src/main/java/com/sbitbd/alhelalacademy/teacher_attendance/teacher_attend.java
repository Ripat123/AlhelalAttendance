package com.sbitbd.alhelalacademy.teacher_attendance;
...
import com.sbitbd.alhelalacademy.Adapter.teacher_attend_adapter;
import com.sbitbd.alhelalacademy.Adapter.teacher_leave_adapter;
...
public class teacher_attend extends AppCompatActivity {
    ...
    private com.sbitbd.alhelalacademy.Config.config config = new config();
            ...
            try {
                ...
                if (cursor.getCount() > 0) {
                    while (cursor.moveToNext()) {
                        attend_model = new attend_model(cursor.getString(cursor.getColumnIndexOrThrow("id"))
                                , cursor.getString(cursor.getColumnIndexOrThrow("name")),
                                cursor.getString(cursor.getColumnIndexOrThrow("phone")), "0",
                                cursor.getString(cursor.getColumnIndexOrThrow("id")) + ".jpg");
