package com.sbitbd.alhelalacademy.ui.teacher_gap;
...
import com.sbitbd.alhelalacademy.Adapter.teacher_atd_adapter;
...
public class teacher_gap extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_teacher_gap, container, false);
        initView();
        return root;
    }
    ...
    private void initView(){
        try {
            recyclerView = root.findViewById(R.id.teacher_gap_rec);
            start_card = root.findViewById(R.id.start_card1);
            end_card = root.findViewById(R.id.end_card1);
            teacher_atd_adapter = new teacher_atd_adapter(root.getContext().getApplicationContext(),2);
            teacher_atd_adapter1 = new teacher_atd_adapter(root.getContext().getApplicationContext(),3);
            ...
            get_leave(root.getContext().getApplicationContext(), "SELECT " +
                    ...
                    "" + config.attend_date() + "' and start_time is not null and end_time is null and attendance='1'",teacher_atd_adapter);
            ...
            end_card.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    get_leave(root.getContext().getApplicationContext(), "SELECT " +
                            "teacher_id AS 'one' from teacher_gap_time WHERE attend_date = '" +
                            "" + config.attend_date() + "' and start_time is not null and end_time is null",teacher_atd_adapter1);
                }
            });
        }catch (Exception e){
        }
